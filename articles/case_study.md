...
#> Warning in run_mofa(model, use_basilisk = TRUE): No output filename provided. Using /tmp/RtmptChFHc/mofa_20260708-182241.hdf5 to store the trained model.
...
#> + /github/home/.cache/R/basilisk/1.25.0/MOFA2/1.23.0/mofa_env/bin/python -m pip install --upgrade pip wheel setuptools
#> + /github/home/.cache/R/basilisk/1.25.0/MOFA2/1.23.0/mofa_env/bin/python -m pip install --upgrade --no-user 'numpy==1.26.4' 'scipy==1.12.0' 'pandas==2.2.1' 'h5py==3.10.0' 'scikit-learn==1.4.0' 'dtw-python==1.3.1' 'mofapy2==0.7.3'
```
...
#>  [1] shadowtext_0.1.6                scater_1.41.2                  
#>  [3] scuttle_1.23.1                  reticulate_1.46.0              
#>  [5] patchwork_1.3.2                 MOFA2_1.23.0                   
#>  [7] miaViz_1.21.1                   ggraph_2.2.2                   
#>  [9] ggplot2_4.0.3                   mia_1.21.3                     
#> [11] MGnifyR_1.9.0                   HoloFoodR_1.2.0                
...
#>  [29] rappdirs_0.3.4              gdtools_0.5.1              
#>  [31] ggrepel_0.9.8               irlba_2.3.7                
#>  [33] tokenizers_0.3.0            tidytree_0.4.8             
#>  [35] pheatmap_1.0.13             vegan_2.7-5                
#>  [37] pkgdown_2.2.1               permute_0.9-10             
#>  [39] DelayedMatrixStats_1.35.0   codetools_0.2-20           
#>  [41] DelayedArray_0.39.3         ggforce_0.5.0              
#>  [43] tidyselect_1.2.1            aplot_0.3.1                
#>  [45] farver_2.1.2                ScaledMatrix_1.21.0        
#>  [47] viridis_0.6.5               jsonlite_2.0.0             
#>  [49] BiocNeighbors_2.7.2         decontam_1.33.0            
#>  [51] tidygraph_1.3.1             systemfonts_1.3.2          
#>  [53] tools_4.6.1                 ggnewscale_0.5.2           
#>  [55] treeio_1.37.0               ragg_1.5.2                 
#>  [57] Rcpp_1.1.2                  glue_1.8.1                 
#>  [59] BiocBaseUtils_1.15.1        gridExtra_2.3.1            
#>  [61] SparseArray_1.13.2          xfun_0.59                  
#>  [63] mgcv_1.9-4                  HDF5Array_1.41.0           
#>  [65] withr_3.0.3                 BiocManager_1.30.27        
#>  [67] fastmap_1.2.0               ggh4x_0.3.1                
#>  [69] basilisk_1.25.0             rhdf5filters_1.25.0        
#>  [71] bluster_1.23.0              digest_0.6.39              
#>  [73] rsvd_1.0.5                  R6_2.6.1                   
#>  [75] gridGraphics_0.5-1          textshaping_1.0.5          
#>  [77] h5mread_1.5.0               ecodive_2.2.6              
#>  [79] UpSetR_1.4.1                tidyr_1.3.2                
#>  [81] fontLiberation_0.1.0        DECIPHER_3.9.0             
#>  [83] graphlayouts_1.2.4          httr_1.4.8                 
#>  [85] htmlwidgets_1.6.4           S4Arrays_1.13.0            
#>  [87] uwot_0.2.4                  pkgconfig_2.0.3            
#>  [89] gtable_0.3.6                S7_0.2.2                   
#>  [91] janeaustenr_1.0.0           htmltools_0.5.9            
#>  [93] fontBitstreamVera_0.1.1     bookdown_0.47              
#>  [95] scales_1.4.0                png_0.1-9                  
#>  [97] corrplot_0.95               ggfun_0.2.1                
#>  [99] reshape2_1.4.5              nlme_3.1-169               
#> [101] cachem_1.1.0                rhdf5_2.57.1               
#> [103] stringr_1.6.0               parallel_4.6.1             
#> [105] vipor_0.4.7                 desc_1.4.3                 
#> [107] pillar_1.11.1               grid_4.6.1                 
#> [109] vctrs_0.7.3                 BiocSingular_1.29.0        
#> [111] beachmat_2.29.0             cluster_2.1.8.2            
#> [113] beeswarm_0.4.0              evaluate_1.0.5             
#> [115] cli_3.6.6                   compiler_4.6.1             
#> [117] rlang_1.3.0                 crayon_1.5.3               
#> [119] tidytext_0.4.3              labeling_0.4.3             
#> [121] forcats_1.0.1               plyr_1.8.9                 
#> [123] fs_2.1.0                    ggbeeswarm_0.7.3           
#> [125] ggiraph_0.9.6               stringi_1.8.7              
#> [127] viridisLite_0.4.3           BiocParallel_1.47.0        
#> [129] lazyeval_0.2.3              fontquiver_0.2.1           
#> [131] Matrix_1.7-5                dir.expiry_1.21.0          
#> [133] sparseMatrixStats_1.25.0    Rhdf5lib_2.1.0             
#> [135] igraph_2.3.3                memoise_2.0.1              
#> [137] bslib_0.11.0                ggtree_4.3.0               
#> [139] ape_5.8-1
```
